...
Currently, RHEL 6, RHEL 7, Debian and Ubuntu provide native Gluster packages.
...
On Ubuntu systems, only the first two version places are significant ("x.y"). The latest minor version from that release will be installed unless the "priority" parameter is used.
