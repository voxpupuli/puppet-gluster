      ...
      case $::lsbdistcodename {
        'jessie', 'stretch':  {
          ...
          if versioncmp($release, '3.12') < 0 {
            $repo_url  = "https://download.gluster.org/pub/gluster/glusterfs/${repo_ver}/Debian/${::lsbdistcodename}/apt/"
          } else {
            $repo_url  = "https://download.gluster.org/pub/gluster/glusterfs/${repo_ver}/Debian/${::lsbdistcodename}/${arch}/apt/"
          }
        }
      }
    }
